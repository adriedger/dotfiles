...
hi def link     goImport            Preproc
hi def link     goVar               Type
hi def link     goConst             Type
hi def link     goDeclaration       Type
...
" Predefined types
syn keyword     goType              chan bool string error
...
hi def link     goEscapeOctal       Statement
hi def link     goEscapeC           Statement
hi def link     goEscapeX           Statement
hi def link     goEscapeU           Statement
hi def link     goEscapeBigU        Statement
...
if g:go_highlight_format_strings != 0
  ...
  hi def link     goFormatSpecifier   Statement
endif
